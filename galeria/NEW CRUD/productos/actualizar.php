        ...
        <br><br><br><br>
            ...
            <div class="col-sm-12 col-md-8  p-3 mb-2 p-3 mb-2 bg-info text-dar">
                <form action="update.php" method="POST">
                    <h3>id_productos</h3> 
                    <input type="text" class="form-control mb-3" name="id_productos" placeholder="Password" value="<?php echo $row['0']  ?>">
                    <h3>Producto</h3>
                    <input type="text" class="form-control mb-3" name="Producto" placeholder="Password" value="<?php echo $row['1']  ?>">
                    <h3>Valor</h3>

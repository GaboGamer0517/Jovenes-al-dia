...
$sql = "SELECT * FROM página WHERE id_pagina ='$id_pagina'";
        ...
        <br><br><br><br>
            ...
            <div class="col-sm-12 col-md-8  p-3 mb-2 p-3 mb-2 bg-info text-dar">
                <form action="update.php" method="POST">
                    <h3>id_pagina</h3> 
                    <input type="text" class="form-control mb-3" name="id_pagina" placeholder="Password" value="<?php echo $row['0']  ?>">
                    <h3>servicios</h3>
                    <input type="text" class="form-control mb-3" name="servicios" placeholder="Password" value="<?php echo $row['1']  ?>">
                    <h3>ayuda</h3>
                    <input type="text" class="form-control mb-3" name="ayuda" placeholder="Password" value="<?php echo $row['2']  ?>">
                    <h3>administrador</h3>

...
<br>
            <div class="col-md-4  p-3 mb-2 p-3 mb-2 bg-info text-dar ">
                ...
                <form action="insertar.php" method="POST">
                    <input type="text" class="form-control mb-3" name="id_pagina" placeholder="id_pagina">
                    <input type="text" class="form-control mb-3" name="servicios" placeholder="servicios">
                    <input type="text" class="form-control mb-3" name="ayuda" placeholder="ayuda">
                    <input type="text" class="form-control mb-3" name="administrador" placeholder="administrador">

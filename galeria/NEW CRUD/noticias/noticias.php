...
<br>
            <div class="col-md-4  p-3 mb-2 p-3 mb-2 bg-info text-dar ">
                ...
                <form action="insertar.php" method="POST">
                    <input type="text" class="form-control mb-3" name="id_noticias" placeholder="id_noticias">
                    <input type="text" class="form-control mb-3" name="tipo_noticia" placeholder="tipo_noticia">

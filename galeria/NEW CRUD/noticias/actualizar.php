        ...
        <br><br><br><br>
            ...
            <div class="col-sm-12 col-md-8  p-3 mb-2 p-3 mb-2 bg-info text-dar">
                <form action="update.php" method="POST">
                    <h3>id_noticias</h3> 
                    <input type="text" class="form-control mb-3" name="id_noticias" placeholder="Password" value="<?php echo $row['0']  ?>">
                    <h3>tipo_noticia</h3>
                    <input type="text" class="form-control mb-3" name="tipo_noticia" placeholder="Password" value="<?php echo $row['1']  ?>">
                    <h3>fecha</h3>
                    <input type="text" class="form-control mb-3" name="fecha" placeholder="Password" value="<?php echo $row['2']  ?>">

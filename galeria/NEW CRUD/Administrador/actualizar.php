        ...
        <br><br><br><br>
            ...
            <div class="col-sm-12 col-md-8  p-3 mb-2 p-3 mb-2 bg-info text-dar">
                <form action="update.php" method="POST">
                    <h3>id_administrador</h3> 
                    <input type="text" class="form-control mb-3" name="id_administrador" placeholder="Password" value="<?php echo $row['0']  ?>">
                    <h3>email</h3>
                    <input type="text" class="form-control mb-3" name="email" placeholder="Password" value="<?php echo $row['1']  ?>">
                    <h3>nombre</h3>
                    <input type="text" class="form-control mb-3" name="nombre" placeholder="Password" value="<?php echo $row['2']  ?>">
                    <h3>Teléfono</h3>
                    <input type="text" class="form-control mb-3" name="Teléfono" placeholder="Password" value="<?php echo $row['3']  ?>">
                    <h3>Id_roles</h3>

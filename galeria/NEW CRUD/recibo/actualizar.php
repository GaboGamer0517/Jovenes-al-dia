...
$sql = "SELECT * FROM recibo WHERE id_recibo ='$id_recibo'";
        ...
        <br><br><br><br>
            ...
            <div class="col-sm-12 col-md-8  p-3 mb-2 p-3 mb-2 bg-info text-dar">
                <form action="update.php" method="POST">
                    <h3>id_recibo</h3> 
                    <input type="text" class="form-control mb-3" name="id_recibo" placeholder="Password" value="<?php echo $row['0']  ?>">
                    <h3>Fecha</h3>
                    <input type="text" class="form-control mb-3" name="Fecha" placeholder="Password" value="<?php echo $row['1']  ?>">
                    <h3>Valor</h3>
                    <input type="text" class="form-control mb-3" name="Valor" placeholder="Password" value="<?php echo $row['2']  ?>">
                    <h3>Cantidad</h3>
                    <input type="text" class="form-control mb-3" name="Cantidad" placeholder="Password" value="<?php echo $row['3']  ?>">
                    <h3>transaccion</h3>
                    <input type="text" class="form-control mb-3" name="transaccion" placeholder="Password" value="<?php echo $row['4']  ?>">

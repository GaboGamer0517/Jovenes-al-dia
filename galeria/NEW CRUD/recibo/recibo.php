...
<br>
            <div class="col-md-4  p-3 mb-2 p-3 mb-2 bg-info text-dar ">
                ...
                <form action="insertar.php" method="POST">
                    <input type="text" class="form-control mb-3" name="id_recibo" placeholder="id_recibo">
                    ...
                    <input type="text" class="form-control mb-3" name="transaccion" placeholder="transaccion">

        ...
        <br><br><br><br>
            ...
            <div class="col-sm-12 col-md-8  p-3 mb-2 p-3 mb-2 bg-info text-dar">
                <form action="update.php" method="POST">
                    <h3>id_eventos</h3> 
                    <input type="text" class="form-control mb-3" name="id_eventos" placeholder="Password" value="<?php echo $row['0']  ?>">
                    <h3>tipo_evento</h3>
                    <input type="text" class="form-control mb-3" name="tipo_evento" placeholder="Password" value="<?php echo $row['1']  ?>">
                    <h3>fecha</h3>
